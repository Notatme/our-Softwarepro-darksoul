...
//    通过id登录的用户查看评审总表信息
    List<Personal_reviewall> querypersonalReviewallbyid(String PersonalUserid);

//   通过电话登录的用户查看评审总表信息
    List<Personal_reviewall> querypersonalReviewallbyPhonenumber(String Phonenumber);
    //在评审总表界面将其中一条评审表删除。
